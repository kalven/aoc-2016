...
// This was probably the first AoC this year that was slightly more tricky. In
// the end I went with a BFS with a hash set to keep track of visited
// states. Runtime for part one was 0.3s.

enum Element { Polonium, Thulium, Promethium, Ruthenium, Cobalt };
...
struct state {
  ...
  vector<state> moves() const {
    ...
    // Generate all one & two object moves.
